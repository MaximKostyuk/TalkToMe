...
while True:
	...
	print ("Предложеные функции: 1.Хочу узнать информацию о моем персональном дневнике, 2.Хочу записать в дневник, 3.Проверить буквы в дневнике, 4.Поиграть в Пинг-Понг")
	order = int(input("Я хочу: "))
	#Выдает, что написано в дневнике
	if order == 1:
		...
		personalNote.close()
	#Записывает в дневник, и должно показывать, что уже записано.
	if order == 2:
